this["dwtwa_gettestresultdocuments"] =
...
/***/ "./src/twa/twa-getresultdocuments.ts":
/*!*******************************************!*\
  !*** ./src/twa/twa-getresultdocuments.ts ***!
  \*******************************************/
/*! no static exports found */
...
var filenames_1 = __webpack_require__(/*! ../configuration/filenames */ "./src/configuration/filenames.ts");
var TwaTestResultDocuments = (function () {
    function TwaTestResultDocuments() {
    }
    TwaTestResultDocuments.prototype.getTestStepResultDocumentsByServiceOrderNumber = function () {
        this.deleteTwaFiles()
            .then(this.readServiceOrderNumbers.bind(this))
            .then(this.getTestStepResultHeaderAnnotations.bind(this))
            .then(function () {
    ...
    TwaTestResultDocuments.prototype.getTestStepResultHeaderAnnotations = function (serviceOrderNumbers) {
        return new Promise(function (resolve, reject) {
            var promiseRequests = [];
            var annotationDataAccess = new annotation_1.AnnotationDataAccess();
            serviceOrderNumbers.forEach(function (serviceOrderNumber) {
                promiseRequests.push(annotationDataAccess.retrieveTestStepResultDocumentAnnotationsForServiceOrderNumber(serviceOrderNumber));
            });
            Promise.all(promiseRequests)
                ...
                fileoperations_1.saveToJsonFile(annotations, filenames_1.FileNames.TwaTestStepResultDocumentAnnotations);
    ...
    TwaTestResultDocuments.prototype.readServiceOrderNumbers = function () {
        return new Promise(function (resolve, reject) {
            fileoperations_1.readFromJsonFile('Command GetTestResultDocuments.json')
                .then(function (commandResults) {
                var serviceOrderNumbers = new Array();
                for (var i = 0; i < commandResults.length; i++) {
                    serviceOrderNumbers.push(commandResults[i].ServiceOrderNumber);
                }
                resolve(serviceOrderNumbers);
            }).catch(function (error) {
                reject(error);
            });
        });
    };
    TwaTestResultDocuments.prototype.deleteTwaFiles = function () {
        return new Promise(function (resolve, reject) {
            Promise.all([
                fileoperations_1.deleteTwaFile(filenames_1.FileNames.TwaTestStepResultDocumentAnnotations),
                fileoperations_1.deleteTwaFile(filenames_1.FileNames.DataReady),
            ]).then(function () {
                resolve();
            }).catch(function (error) {
                reject(error);
    ...
    return TwaTestResultDocuments;
}());
exports.TwaTestResultDocuments = TwaTestResultDocuments;
...
/***/ 5:
/*!*************************************************!*\
  !*** multi ./src/twa/twa-getresultdocuments.ts ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\torsten.kayser\source\repos\Drg365\Source\Project\RescoClient\src\twa\twa-getresultdocuments.ts */"./src/twa/twa-getresultdocuments.ts");


/***/ })

/******/ });
//# sourceMappingURL=twa_gettestresultdocuments.resco.js.map